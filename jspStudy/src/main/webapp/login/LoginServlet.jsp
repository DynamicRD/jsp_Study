            ...
            <table border="1" width="300" id="my_table">
                ...
                <tr>
                    <td align="center" colspan="2">
                        <input type="button" onclick="location.href = 'loginMemberServlet.jsp'" value="회원가입">
...
%>
            ...
            <table border="1" width="500" id="my_table">
                ...
                <tr>
                    <td align="center">
                        <input type="button" onclick="location.href = 'loginMemberList.jsp'" value="회원들 정보">
                        <input type="button" onclick="location.href = 'logoutServlet.jsp'" value="로그아웃">
                    </td>
                </tr>
            </table>
...
%>
            ...
            <table border="1" width="500" id="my_table">
                ...
                <tr>
                    <td align="center">
                        <input type="button" onclick="location.href = 'loginMemberChange.jsp'" value="회원정보변경">
                        <input type="button" onclick="location.href = 'logoutServlet.jsp'" value="로그아웃">
                        <input type="button" onclick="location.href = 'memberReallyDelete.jsp'" value="탈퇴하기">
                    </td>
                </tr>
            </table>
<%
